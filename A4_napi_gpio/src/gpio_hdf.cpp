...
// direction
const int UM_GPIO_DIRECTION_IN = 0
const int UM_GPIO_DIRECTION_OUT = 1

// is export
const int UM_GPIO_NOT_EXPORT = 0
const int UM_GPIO_EXPORTED = 1

// errno
const int UM_GPIO_ERR = (-1)
const int UM_GPIO_NOT_EXPROT_ERROR = (-2)

// value high - low level
const int UM_GPIO_LOW_LEVE = 0
const int UM_GPIO_HIGH_LEVE = 1
